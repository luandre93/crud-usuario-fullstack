...
CREATE TABLE `groupusers` (
  ...
  PRIMARY KEY (`id`),
  KEY `groupusers_FK` (`group_id`) USING BTREE,
  KEY `groupusers_FK_1` (`user_id`) USING BTREE,
  KEY `groupusers_FK_2` (`rule_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-03  0:18:17
